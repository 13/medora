...
final parityScript = <ParityStep>[
  ...
  ParityStep.insert('0.7.0 inserts another prescription document', 'rx', {
    'id': 'par-rx2',
    'user_id': _parityUser,
    'kind': 'ssn',
    'issued_on': '2020-05-01',
  ...
  ParityStep.insert('and an attachment of it', 'attachments', {
    'id': 'par-att1',
    'user_id': _parityUser,
    'owner_kind': 'rx',
    'owner_id': 'par-rx2',
    ...
    'write_id': _uuid(21),
    'edited_at': _may,
    'field_edited_at': {'owner_id': _at(_may)},
  }),
  ParityStep.insert(
    "and a treatment's attachment that names the same id",
    'attachments',
    {
      'id': 'par-att2',
      'user_id': _parityUser,
  ...
  ParityStep.update(
    'a person deletes the prescription: the tombstone cascades to its '
        "attachment as the app's own change, not to the treatment's",
    'rx',
    'par-rx2',
    {'deleted_at': _may, 'write_id': _uuid(23), 'edited_at': _may},
    check: const [
      ('rx', 'par-rx2'),
      ('attachments', 'par-att1'),
      ('attachments', 'par-att2'),
    ],
  ),
  ParityStep.insert(
    'a device that has not heard of it sends an attachment: stored deleted',
    'attachments',
    {
      'id': 'par-att3',
      'user_id': _parityUser,
