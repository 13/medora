...
class MedoraColors extends ThemeExtension<MedoraColors> {
  ...
  factory MedoraColors.forScheme(ColorScheme scheme) {
    ...
    return MedoraColors(
      ...
      danger: d.primary,
      onDanger: d.onPrimary,
      dangerContainer: d.primaryContainer,
      onDangerContainer: d.onPrimaryContainer,
      neutral: n.primary,
      onNeutral: n.onPrimary,
      neutralContainer: n.primaryContainer,
      onNeutralContainer: n.onPrimaryContainer,
    );
  }
  ...
  MedoraColors lerp(ThemeExtension<MedoraColors>? other, double t) {
    ...
    return MedoraColors(
      ...
      onNeutral: l(onNeutral, other.onNeutral),
